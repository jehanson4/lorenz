...
public class LorenzLab {
	...
	public LorenzLab() {
		...
		this.controller.addScenario("RotatingPendulum", new RotatingPendulumScenario());
		this.controller.addScenario("PlanarPendulum", new PlanarPendulumScenario());
